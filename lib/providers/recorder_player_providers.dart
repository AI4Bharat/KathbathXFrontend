...
class RecorderPlayerInfoProvider extends ChangeNotifier {
  ...
  String get totalDurationInString =>
      convertDurationToString(_totalDuration);

  int get currentProgress => _currentProgress;
  String get currentProgressInString => _isPlaying.toString();
