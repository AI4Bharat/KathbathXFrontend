...
object Dependencies {
    ...
    object CameraX {
        const val camerCore = "androidx.camera:camera-core:${CAMERAX_VERSION}"
        ...
        const val cameraVideo = "androidx.camera:camera-video:${CAMERAX_VERSION}"

        const val cameraView = "androidx.camera:camera-view:${CAMERAX_VERSION}"
        const val cameraExtension = "androidx.camera:camera-extensions:${CAMERAX_VERSION}"
    }
