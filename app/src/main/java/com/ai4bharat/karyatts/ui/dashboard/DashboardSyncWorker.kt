package com.ai4bharat.karyatts.ui.dashboard
...
import com.ai4bharat.karyatts.data.model.karya.ChecksumAlgorithm
import com.ai4bharat.karyatts.data.model.karya.MicroTaskAssignmentRecord
import com.ai4bharat.karyatts.data.remote.request.UploadFileRequest
...
import com.ai4bharat.karyatts.utils.DateUtils
import com.ai4bharat.karyatts.utils.FileUtils
import com.ai4bharat.karyatts.utils.MicrotaskAssignmentOutput
import com.ai4bharat.karyatts.utils.MicrotaskInput
import com.ai4bharat.karyatts.utils.extensions.getBlobPath
...
class DashboardSyncWorker(
  ...
  private suspend fun syncWithServer() {
    ...
    // Clean up karyatts files. This should never result in an error
    cleanupKaryaFiles()
  ...
  /**
   * Remove karyatts files that are already uploaded to the server. Remove input files of submitted
   * microtasks
   */
  private suspend fun cleanupKaryaFiles() {
    // Get all assignments whose output karyatts files are uploaded to the server
