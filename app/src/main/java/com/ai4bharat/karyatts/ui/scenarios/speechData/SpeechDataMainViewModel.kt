package com.ai4bharat.karyatts.ui.scenarios.speechData
...
import com.ai4bharat.karyatts.ui.scenarios.speechData.SpeechDataMainViewModel.ButtonState.*
import com.ai4bharat.karyatts.utils.PreferenceKeys
import com.ai4bharat.karyatts.utils.RawToAACEncoder
...
//    setButtonStates(ENABLED,ENABLED,ENABLED,ENABLED)
  ...
  fun setupSpeechDataViewModel() {
    ...
    outputRecordingFileParams = if (compressAudio) Pair("", "m4a") else outputRecordingFileParams //changed Pain("","wav")
