...
import com.ai4bharat.karyatts.data.manager.BaseUrlManager
import com.ai4bharat.karyatts.data.remote.interceptors.HostSelectionInterceptor
import com.ai4bharat.karyatts.data.remote.interceptors.IdTokenRenewInterceptor
import com.ai4bharat.karyatts.data.remote.interceptors.VersionInterceptor
import com.ai4bharat.karyatts.data.repo.AuthRepository
import com.ai4bharat.karyatts.data.service.KaryaFileAPI
import com.ai4bharat.karyatts.data.service.LanguageAPI
import com.ai4bharat.karyatts.data.service.MicroTaskAssignmentAPI
import com.ai4bharat.karyatts.data.service.WorkerAPI
import com.ai4bharat.karyatts.injection.qualifier.BaseUrl
import com.ai4bharat.karyatts.injection.qualifier.KaryaOkHttpClient
