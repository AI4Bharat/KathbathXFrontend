package com.ai4bharat.karya.ui.onboarding.login.phone
...
//      val phdetails = JsonParser.parseString("{\"extras\":{\"manufacturer\":\"" + Build.MANUFACTURER + "\",\"model\":\"" + Build.MODEL + "\",\"product\":\"" + Build.PRODUCT + "\"}}");
//      val phworker = worker.copy(gender = "phdetails")
//      println(phdetails)
//      workerRepository.upsertWorker(phworker)
