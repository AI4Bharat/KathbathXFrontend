...
//          val language = worker.
                    ...
                    if (languageCode.equals("ks", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_kashmiri))
                    } else if (languageCode.equals("doi", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_english))
                    } else if (languageCode.equals("mni", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_manipuri))
                    } else if (languageCode.equals("as", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_assamese))
                        ...
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_maithili))
                    } else if (languageCode.equals("sa", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_english))
                    } else if (languageCode.equals("bn", true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_bengali))
                        ...
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_konkani))
                    } else if (languageCode.equals("gu", ignoreCase = true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_gujarati))
                        ...
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_kannada))
                    } else if (languageCode.equals("mr", ignoreCase = true)) {
                        consentFormTv.text =
                            text2html(getString(R.string.consent_form_text_marathi))
