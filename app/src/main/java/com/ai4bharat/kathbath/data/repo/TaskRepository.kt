...
constructor(
    ...
    suspend fun getTaskStatus(taskId: String): TaskStatus {
        ...
        val skipped =
            microTaskAssignmentDao.getCountForTask(taskId, MicrotaskAssignmentStatus.SKIPPED)
        val expired =
            microTaskAssignmentDao.getCountForTask(taskId, MicrotaskAssignmentStatus.EXPIRED)
        var pp = microTaskAssignmentDao.getDurationForCompletedTask(
            taskId,
