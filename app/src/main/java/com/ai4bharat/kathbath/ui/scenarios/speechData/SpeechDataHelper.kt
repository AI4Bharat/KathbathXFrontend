...
fun getInstructionSentence(language: String): String {
    when (language) {
        ...
        "Bengali" -> return "নির্দেশঃ দয়া করে বাংলায় কথা বলুন। / Please speak in $language"
        ...
        "Maithili" -> return "निर्देशः कृपया कश्मीरीमे बात करू। / Please speak in $language"
        ...
        "Santali" -> return "ᱱᱩᱛᱚᱱᱟᱹᱥᱼᱢᱮᱧ ᱠᱟᱛᱮ ᱥᱚᱱᱛᱚᱞᱤ ᱯᱟᱹᱨᱥᱤ ᱛᱮ ᱠᱟᱛᱷᱟ ᱞᱟᱹᱭ ᱢᱮ ᱾ / Please speak in $language"
        ...
        "Urdu" -> return " ہدایات: براہ کرم اردو میں بات کریں"
